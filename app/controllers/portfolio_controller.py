...
def skills():
    # Sample skills
    skills = [
        Skill(name="Python", proficiency="Advanced", description="Experienced in Python for data analysis and web development."),
        Skill(name="Machine Learning", proficiency="Advanced", description="Skilled in scikit-learn, TensorFlow, and Keras."),
        Skill(name="SQL", proficiency="Intermediate", description="Proficient in SQL for database querying and management.")
    ]
