    ...
    def create_sample_data():
        ...
        sample_projects = [
            ...
            Project(
                ...
                description="Educational tool powered by LangChain and Streamlit that transforms course notes into interactive flashcards using local language model (Ollama + Phi) with no external API dependencies. Features built-in OCR, user-friendly interface, and fully offline operation.",
                technology_used="LangChain, Streamlit, Ollama, Phi, NLP, Educational AI, Local LLM, OCR",
                duration="5 weeks",
            ...
            Project(
                ...
                description="Deep learning application using CNN for malaria detection from blood cell images. Provides an intuitive interface to upload images and receive predictions, making it accessible for medical practitioners and researchers.",
                technology_used="Python, TensorFlow, CNN, Computer Vision, Streamlit, Deep Learning",
                duration="4 weeks",
            ...
            Project(
                ...
                description="Django web application for malaria detection from medical images using a pre-trained CNN model for real-time classification. Leverages a pre-trained Convolutional Neural Network (CNN) model for real-time predictions.",
            ...
            Project(
                ...
                description="Flask-based web application for clustering datasets with PCA and K-Means. Features dynamic file uploads, visualizations, and synthetic data generation for testing. Perfect for exploring clustering techniques interactively!",
            ...
            Project(
                ...
                description="NutriScore Wizard is a web application that predicts the NutriScore grade for food products based on their nutritional information. The app provides an intuitive interface for users to input product details.",
            ...
            Project(
                ...
                description="Comprehensive audio analysis toolkit built with Python, featuring waveform visualization, spectral analysis, STFT, MFCC extraction, and sound classification using Librosa and Streamlit.",
            ...
            Project(
                ...
                description="Machine learning project comparing linear regression and neural networks for Boston housing price prediction. Includes feature engineering, model evaluation, and performance comparison analysis.",
            ...
            Project(
                ...
                description="Streamlit-based tool designed to assist in the diagnosis of behavioral and attention-related disorders using the TRAQ questionnaire. Computes key scores, visualizes results, and generates detailed reports for download.",
            ...
            Project(
                ...
                description="Personal project for a simple movie ticket booking application. The app integrates with the OMDB API to fetch and display movie details, allows users to calculate ticket costs, and manages a shopping cart using local storage.",
            ...
            Project(
                ...
                description="Java-based solution designed for managing clients, contracts, and related business entities within a database. Built on robust object-oriented principles, it provides functionalities such as database connectivity, CRUD operations, and structured exception handling.",
            ...
            Project(
                ...
                description="Collection of OCR projects including PaddleOCR, EasyOCR, and Tesseract implementations. Lightweight web interfaces for fast, accurate text extraction from French receipts and documents with GPU-friendly processing.",
                technology_used="Python, PaddleOCR, EasyOCR, Tesseract, Streamlit, OCR",
                duration="6 weeks",
                project_type="ai_automation",
            ...
            Project(
                ...
                description="Scrapy project to scrape book data from Books to Scrape and saves the extracted information in a CSV file. Demonstrates web scraping techniques and data extraction workflows.",
                technology_used="Python, Scrapy, BeautifulSoup, Data Extraction, CSV",
                duration="2 weeks",
                project_type="data_science",
